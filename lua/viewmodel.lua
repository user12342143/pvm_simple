...
diff --git a/lua/viewmodel.lua b/lua/viewmodel.lua
index 740cdda6b2971fc40d8890ed6631c229d4cd6acf..6b337bf561172a5028a9dfbbb6e8b8101d94236b 100644
--- a/lua/viewmodel.lua
+++ b/lua/viewmodel.lua
@@ -1,421 +1,254 @@
- (cd "$(git rev-parse --show-toplevel)" && git apply --3way <<'EOF' 
-diff --git a/lua/viewmodel.lua b/lua/viewmodel.lua
-index ab7869098d5a44f30b7c5813937d096a8beb3628..9308389cf7a4c3e34ea94a73105806689d0c0046 100644
---- a/lua/viewmodel.lua
-+++ b/lua/viewmodel.lua
-@@ -1,254 +1,218 @@
- -- Viewmodel Module
